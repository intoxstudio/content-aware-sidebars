 ...
 */
!function(a){var b={suggestSidebars:function(){var b=a(".js-cas-sidebars");b.each(function(){$this=a(this),$this.select2({containerCssClass:"cas-select2",dropdownCssClass:"cas-select2",minimumInputLength:0,closeOnSelect:!0,allowClear:!0,multiple:!0,maximumSelectionSize:1,data:$this.data("sidebars"),width:"100%",createSearchChoice:function(b,c){return b&&0===a(c).filter(function(){return 0===this.text.localeCompare(b)}).length?{id:"_"+b.replace(",","_"),text:b}:null},formatSelection:function(a){return(a.id>0?"":"<b>("+CAS.labelNew+")</b> ")+a.text},formatResult:function(a){return(a.id>0?"":"<b>"+CAS.createNew+":</b> ")+a.text},formatNoMatches:function(){return CAS.notFound}})})}};a(document).ready(function(){b.suggestSidebars()})}(jQuery);