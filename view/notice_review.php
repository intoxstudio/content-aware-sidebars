...
<p>
<?php printf(__("Hey %s, you have used %s for some time now, and I hope you like it so far!",'content-aware-sidebars'),
	'<strong>'.$current_user->display_name.'</strong>',
	'<strong>Content Aware Sidebars</strong>'
); ?>
<br>
<?php printf(__("May I ask you to %ssupport it with a 5-star rating%s? I have spent countless hours on the plugin, and this will help make it even better.",'content-aware-sidebars'),
